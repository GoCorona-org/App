...
import simplifii.framework.widgets.styleabletoast.CustomTextViewFontMapper;
...
//    });
    ...
    private void setCustomFont(Context ctx, AttributeSet attrs) {
        ...
        String customFont = CustomTextViewFontMapper.getMappingFont(a.getString(R.styleable.CustomFontTxtView_customFont));
